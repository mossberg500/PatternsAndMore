package ua.lov.letscodestreamapi;

import org.junit.Test;
import ua.lov.letscodestreamapi.domain.Department;
import ua.lov.letscodestreamapi.domain.Employee;
import ua.lov.letscodestreamapi.domain.Event;
import ua.lov.letscodestreamapi.domain.Position;
...
public class Streams {
    ...
    public void creation() throws IOException {
       ...
       // Stream<String> lines = Files.lines(Paths.get("some.txt"));
        ...
        Stream<String> build1 = Stream.<String>builder()
                .add("Mike")
                .add("joe")
                .build();
        ...
        Stream<String> concat = Stream.concat(stringStream, build1);
